...
public class MonitrStockDetails implements IMonitrStockDetails{
    ...
    public MonitrStockDetails(String industry, String name, String sector, String symbol, int status, String description, List<String> alias, List<String> competitors, Future<IMonitrStockAnalysisData> analysis) {
    ...
    public static IMonitrStockDetails valueOf(MonitrStockDetailsDto dto, Future<IMonitrStockAnalysisData> stockAnalysis) {
